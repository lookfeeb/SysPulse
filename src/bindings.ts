...
export type InterfaceStats = { luid: number; name: string; description: string; isUp: boolean; isPhysical: boolean; bytesSentTotal: number; bytesRecvTotal: number; bytesSentPerSec: number; bytesRecvPerSec: number }
